...
def build_fit_prompt(
    ...
    return (
        ...
        + (
            ...
            "IMPORTANT: this section is purely informational — it must NOT influence fitness_score or any category score:\n"
            ...
            "  Tailor ONLY the Life Balance and Commute Load categories to the student's stated profile. All other categories are objective.\n"
